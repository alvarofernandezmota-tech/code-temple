...
reorganizó completo el 2026-08-18.
...
una plantilla mínima (Objetivo, Contexto, Decisiones, Cierre), y lo abre
directamente en tu editor (`$EDITOR`, o `nano` por defecto) para que
escribas la sesión en el momento — igual que el diario de midgaror. Más
...
Falta comparar su contenido y fusionarlas en una sola.
